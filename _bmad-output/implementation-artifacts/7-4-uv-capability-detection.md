...
- [ ] **Task 1: Add a pure, unit-testable `uv`-capability parser** (AC #1, #2)
...
- [ ] **Task 2: Add the I/O wrapper, `Result`-preserving (not `bool`-collapsing)** (AC #1, #2, #3)
...
- [ ] **Task 3: Unit tests for the parser** (AC #1, #2 — testing-strategy compliance, AD-7)
