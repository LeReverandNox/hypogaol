...
- Hardware verification (LeReverandNox, 2026-07-28): both bind-hooks and exec-hooks confirmed working as expected against real hardware. This was the last open item from Task 10's Dev Notes ("manual step for LeReverandNox") — story has no further known gaps.
