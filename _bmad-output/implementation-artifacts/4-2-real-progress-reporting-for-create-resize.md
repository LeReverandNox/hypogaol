...
- [ ] [Review][Patch] No test proves a stage's progress message doesn't fire for work that never completed — all 4 new tests use only passing fakes [tests/unit/progress.rs]
