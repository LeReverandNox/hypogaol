...
- [ ] **Task 2: Implement `processes_using`/`signal_process` in `ExecAdapter` (AC #1)**
...
- [ ] **Task 3: Expose `close::run_hooks_step` for reuse (AC #3)**
...
- [ ] **Task 6: Extend test fakes for slam coverage (AC #1, #3, #4)**
